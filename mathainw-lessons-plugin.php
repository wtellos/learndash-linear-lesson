        ...
        <a class='cardet-lesson-grid uk-position-relative uk-animation-fade " . $lesson_completion_class . " " . $lesson_not_available . "' href='" . $lesson_link . "'>
            ...
            <div class='uk-text-center DDuk-text-left cardet-lesson-header'>
                ...
                <div class='BAR uk-margin-top cardet-lesson-bar'>
                    ...
                    <div class='BAR-INNER DDuk-hidden cardet-lesson-bar-inner'></div>
                        <style>.cardet-lesson-bar-inner{width:". $completion_percentage . "%;}</style>

                    <div class='PERCENTAGE'> (" . $completion_percentage . "% complete)</div>
                </div>
            </div>
        </a>
    </div>";
